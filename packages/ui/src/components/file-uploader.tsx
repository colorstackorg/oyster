...
export function FileUploader({ name }: FieldProps<ResourceType>) {
  ...
  return (
    <div>
      <label
        htmlFor={name}
        className="relative flex flex-col items-center rounded-3xl border-2 border-dashed  border-gray-300 p-2 hover:cursor-pointer"
      >
        <div className="flex flex-col items-center p-4">
          <div className="mb-2 flex w-12 items-center justify-center rounded-full bg-gray-200 p-3">
        ...
        <input
          ...
          className="absolute top-0 z-10 h-full w-full rounded-3xl opacity-0 hover:cursor-grab active:cursor-grab"
          required
        ...
        <div className="flex items-center rounded-md bg-white p-2 shadow-sm">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">
              ...
              {/* create a span that acts as a tag */}
