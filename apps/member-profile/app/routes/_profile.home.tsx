...
import { Button, cx, Divider, Modal, Text, useWindowSize } from '@oyster/ui';
...
function FirstTimeConfettiEffect() {
  const [searchParams] = useSearchParams();
  const { height, width } = useWindowSize();
  const [showModal, setShowModal] = useState(false);

  const isFirstTime = searchParams.has('new');
