...
function EditOpportunityForm() {
  ...
  return (
    <RemixForm className="form" method="post" encType="multipart/form-data">
      ...
      <Form.Field
        description="This is the date that the opportunity will be marked as closed. By default, this is set to 3 months from the date the opportunity was posted."
        error=""
        label="Close Date"
        labelFor="closeDate"
        required
