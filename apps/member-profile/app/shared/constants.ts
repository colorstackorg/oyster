const ROUTES = [
  ...
  '/compensation',
  '/compensation/full-time-offers',
  '/compensation/internship-offers',
  '/compensation/full-time-offers/:id',
  '/compensation/full-time-offers/:id/edit',
  '/compensation/full-time-offers/:id/delete',
  '/compensation/internship-offers/:id',
  '/compensation/internship-offers/:id/edit',
  '/compensation/internship-offers/:id/delete',
  '/directory',
  '/directory/join',
  '/directory/join/1',
  '/directory/join/2',
